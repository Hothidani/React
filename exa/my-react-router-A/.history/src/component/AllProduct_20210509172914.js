...
class AllProduct extends Component {
    ...
    onDelete = event => {
        event.preventDefault();
        axios.delete(`https://6093b5e8a7e53a001795161e.mockapi.io/Products/${this.state.product[0].id}`)
            .then(res => {
                console.log(res);
                console.log(res.data);
            })
                 ...
                 {this.state.product.map(element =>
                    ...
                    <div>
                        <form onSubmit={this.onSave}>
                            ...
                            Name:
                            <input type='text' name="name" value={element.product_name} onChange={this.onChange} /><br /><br />
                            Describe
                            <input type='text' name="type" value={element.describe} onChange={this.onChange} /><br /><br />
                            Price:
                            <input type='text' name="quantity" value={element.price} onChange={this.onChange} /><br /><br />
                            <div>
